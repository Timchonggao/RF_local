...
from rfstudio_ds.data import SyntheticDynamicMonocularBlenderDepthDataset, SyntheticDynamicMonocularCostumeDepthDataset, SyntheticDynamicMultiViewCostumeDepthDataset
from rfstudio_ds.model import D_DiffDR
from rfstudio_ds.trainer import D_DiffDRTrainer
...
blender_single_view_beagle_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularBlenderDepthDataset(
        path=Path("data/dg-mesh/beagle/"),
    ),
    model=D_DiffDR(
        geometry='DD_isocubes',
        geometry_resolution=127,
        geometry_scale=1.5,
    ),
    experiment=DS_Experiment(name='d_diffdr_blender_sv/beagle', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
        num_steps_per_orbit_vis=250,
...
blender_single_view_bird_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularBlenderDepthDataset(
    ...
    experiment=DS_Experiment(name='d_diffdr_blender_sv/bird', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
blender_single_view_duck_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularBlenderDepthDataset(
    ...
    experiment=DS_Experiment(name='d_diffdr_blender_sv/duck', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
blender_single_view_girlwalk_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularBlenderDepthDataset(
    ...
    experiment=DS_Experiment(name='d_diffdr_blender_sv/girlwalk', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
blender_single_view_horse_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularBlenderDepthDataset(
    ...
    experiment=DS_Experiment(name='d_diffdr_blender_sv/horse', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
blender_single_view_torus2sphere_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularBlenderDepthDataset(
    ...
    experiment=DS_Experiment(name='d_diffdr_blender_sv/torus2sphere', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
costume_single_view_beagle_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularCostumeDepthDataset(
        path=Path("data/dg-mesh/beagle/"),
    ),
    model=D_DiffDR(
        geometry='DD_isocubes',
    ...
    experiment=DS_Experiment(name='d_diffdr_costume_sv/beagle', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
costume_single_view_bird_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularCostumeDepthDataset(
        path=Path("data/dg-mesh/bird/"),
    ),
    model=D_DiffDR(
    ...
    experiment=DS_Experiment(name='d_diffdr_costume_sv/bird', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
costume_single_view_duck_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularCostumeDepthDataset(
        path=Path("data/dg-mesh/duck/"),
    ),
    model=D_DiffDR(
    ...
    experiment=DS_Experiment(name='d_diffdr_costume_sv/duck', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
costume_single_view_girlwalk_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularCostumeDepthDataset(
        path=Path("data/dg-mesh/girlwalk/"),
    ),
    model=D_DiffDR(
    ...
    experiment=DS_Experiment(name='d_diffdr_costume_sv/girlwalk', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
costume_single_view_horse_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularCostumeDepthDataset(
        path=Path("data/dg-mesh/horse/"),
    ),
    model=D_DiffDR(
    ...
    experiment=DS_Experiment(name='d_diffdr_costume_sv/horse', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
costume_single_view_torus2sphere_task = DS_TrainTask(
    dataset=SyntheticDynamicMonocularCostumeDepthDataset(
        path=Path("data/dg-mesh/torus2sphere/"),
    ),
    model=D_DiffDR(
    ...
    experiment=DS_Experiment(name='d_diffdr_costume_sv/torus2sphere', timestamp='test'),
    trainer=D_DiffDRTrainer(
        num_steps=5000,
        batch_size=32, 
        num_steps_per_val=25,
...
class RenderAfterTrain(Task):
    ...
    def render_and_save_video(self, model: D_DiffDR, trainer: D_DiffDRTrainer, experiment: DS_Experiment, loader, name: str, fix_camera: bool = False, fix_camera_order: int = 0):
...
if __name__ == '__main__':
    TaskGroup(
        # train task
        bsvbeagle = blender_single_view_beagle_task, # python tests_ds/models/test_d_diffdr.py sv_beagle --experiment.timestamp test1
        bsvbird = blender_single_view_bird_task, # python tests_ds/models/test_d_diffdr.py sv_bird --experiment.timestamp test1
        bsvduck = blender_single_view_duck_task, # python tests_ds/models/test_d_diffdr.py sv_duck --experiment.timestamp test1
        bsvgirlwalk = blender_single_view_girlwalk_task, # python tests_ds/models/test_d_diffdr.py sv_girlwalk --experiment.timestamp test1
        bsvhorse = blender_single_view_horse_task, # python tests_ds/models/test_d_diffdr.py svhorse --experiment.timestamp test1
        bsvtorus = blender_single_view_torus2sphere_task, # python tests_ds/models/test_d_diffdr.py sv_torus2sphere --experiment.timestamp test1

        csvbeagle = costume_single_view_beagle_task, # python tests_ds/models/test_d_diffdr.py sv_costume_beagle --experiment.timestamp test1
        csvbird = costume_single_view_bird_task, # python tests_ds/models/test_d_diffdr.py sv_costume_bird --experiment.timestamp test1
        csvduck = costume_single_view_duck_task, # python tests_ds/models/test_d_diffdr.py sv_costume_duck --experiment.timestamp test1
        csvgirlwalk = costume_single_view_girlwalk_task, # python tests_ds/models/test_d_diffdr.py sv_costume_girlwalk --experiment.timestamp test1
        csvhorse = costume_single_view_horse_task, # python tests_ds/models/test_d_diffdr.py sv_costumehorse --experiment.timestamp test1
        csvtorus = costume_single_view_torus2sphere_task, # python tests_ds/models/test_d_diffdr.py sv_costume_torus2sphere --experiment.timestamp test1

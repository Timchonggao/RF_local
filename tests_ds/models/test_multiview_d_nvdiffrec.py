...
cat_task = DS_TrainTask(
    ...
    experiment=DS_Experiment(name='d_nvdiffrec_blender_mv/cat', timestamp='test'),
...
deer_task = DS_TrainTask(
    ...
    experiment=DS_Experiment(name='d_nvdiffrec_blender_mv/deer', timestamp='test'),
    trainer=D_NVDiffRecTrainer(
        num_steps=5000,
        batch_size=4,
        num_steps_per_val=100,
...
girlwalk_task = DS_TrainTask(
    ...
    experiment=DS_Experiment(name='d_nvdiffrec_blender_mv/girlwalk', timestamp='test'),
    trainer=D_NVDiffRecTrainer(
        num_steps=5000,
        batch_size=4,
        num_steps_per_val=100,
...
lego_task = DS_TrainTask(
    ...
    experiment=DS_Experiment(name='d_nvdiffrec_blender_mv/lego', timestamp='test'),
    trainer=D_NVDiffRecTrainer(
        num_steps=5000,
        batch_size=4,
        num_steps_per_val=100,
...
spidermanwalk_task = DS_TrainTask(
    ...
    experiment=DS_Experiment(name='d_nvdiffrec_blender_mv/spidermanwalk', timestamp='test'),
    trainer=D_NVDiffRecTrainer(
        num_steps=5000,
        batch_size=4,
        num_steps_per_val=100,
...
toy_task = DS_TrainTask(
    ...
    model=D_NVDiffRec(
        ...
        dynamic_texture=Grid4d_HashEncoding(
            ...
            grad_scaling=16.0,
            backend='grid4d',
            deform_desired_resolution = [2048,2048,96]
        )
    ),
    experiment=DS_Experiment(name='d_nvdiffrec_blender_mv/toy', timestamp='test'),
    trainer=D_NVDiffRecTrainer(
        num_steps=5000,
        batch_size=4,
        num_steps_per_val=100,

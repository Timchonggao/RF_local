...
for category in "${SynthoCATEGORIES[@]}"; do
    ...
    BASELINE_VISUAL="$SynthoROOT/$category/baselines/dynamic-2dgs/test/ours_40000/renders"
    BASELINE_MESH="$SynthoROOT/$category/baselines/dynamic-2dgs/train/ours_40000"

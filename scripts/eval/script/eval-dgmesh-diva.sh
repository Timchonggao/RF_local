...
for category in "${SynthoCATEGORIES[@]}"; do
    ...
    BASELINE_VISUAL="$SynthoROOT/baselines/dg-mesh/$category/$category/test_results/mesh_image"
    BASELINE_MESH="$SynthoROOT/baselines/dg-mesh/$category/$category/test_results/dynamic_mesh"

...
MethodNmae="neus2"
SCRIPT_PATH="/data3/gaochong/project/RadianceFieldStudio/scripts/eval/gather_img.py"
...
for category in "${SynthoCATEGORIES[@]}"; do
    ...
    BASELINE_VISUAL="$SynthoROOT/baselines/outputs/$category/evaluation/psnr/renders"
    BASELINE_MESH="$SynthoROOT/baselines/outputs/$category/evaluation/psnr/mesh"

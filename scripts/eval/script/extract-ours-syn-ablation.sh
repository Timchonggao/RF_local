...
# 定义类别
SynthoCATEGORIES=("toy" "rabbit")
# AblationCATEGORIES=(
#     "albation-geometry-10000" "albation-geometry-10111" 
#     "albation-geometry-11000" "albation-geometry-11100" 
#     "albation-geometry-11110" "albation-shader-nopbr" 
#     "albation-texture-kplane"
# )
AblationCATEGORIES=(
    "albation-shader-nopbr" 
    "albation-texture-kplane"
)
...
for category in "${SynthoCATEGORIES[@]}"; do
    ...
    for ablation in "${AblationCATEGORIES[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=0 python "$SCRIPT_PATH" extract \
            --load "$LOAD_PATH"
    done
done

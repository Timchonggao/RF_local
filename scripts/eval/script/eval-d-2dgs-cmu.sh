...
for category in "${SynthoCATEGORIES[@]}"; do
    ...
    BASELINE_VISUAL="$SynthoROOT/0_baselines/dynamic-2dgs/$category/train/ours_40000/renders"
    BASELINE_MESH="$SynthoROOT/0_baselines/dynamic-2dgs/$category/train/ours_40000"
